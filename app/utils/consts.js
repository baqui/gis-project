export const MAP_STYLES = [
  {"elementType":"labels.text.fill","stylers":[{"color":"#7c93a3"},{"lightness":"-10"}]},
  ...
  {"featureType":"road.arterial","elementType":"labels.icon","stylers":[{"saturation":"-7"},{"invert_lightness":true},{"lightness":"3"},{"gamma":"1.80"},{"weight":"0.01"}]},
  {"featureType":"road.highway","elementType":"geometry.fill","stylers":[{"color":"#bbcacf"}]},
  {"featureType":"road.highway","elementType":"geometry.stroke","stylers":[{"color":"#bbcacf"},{"lightness":"0"},{"weight":"0.50"}]},
